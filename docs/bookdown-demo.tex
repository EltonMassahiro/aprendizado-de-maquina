...
{\centering \includegraphics[width=0.8\linewidth]{G:/Hiro/Documents/Meus feitos/Livro ML/bookdown-demo-master/Figuras/vetor} 
...
{\centering \includegraphics[width=0.8\linewidth]{G:/Hiro/Documents/Meus feitos/Livro ML/bookdown-demo-master/Figuras/distnormal} 
...
{\centering \includegraphics[width=0.8\linewidth]{G:/Hiro/Documents/Meus feitos/Livro ML/bookdown-demo-master/Figuras/simetria} 
...
{\centering \includegraphics[width=0.8\linewidth]{G:/Hiro/Documents/Meus feitos/Livro ML/bookdown-demo-master/Figuras/assimetria} 
...
{\centering \includegraphics[width=0.8\linewidth]{G:/Hiro/Documents/Meus feitos/Livro ML/bookdown-demo-master/Figuras/curtose} 
...
\tightlist
\item
  \textbf{Aplicações do Teste de Hipótese - Média com a variância conhecida}
\end{enumerate}
...
\tightlist
\item
  \textbf{Aplicações do Teste de Hipótese - Média com a variância desconhecida}
\end{enumerate}
...
{\centering \includegraphics[width=0.7\linewidth]{G:/Hiro/Documents/Meus feitos/Livro ML/bookdown-demo-master/Figuras/kfold} 
...
Para se construir o gráfico ROC, plota-se TFP no eixo das ordenada (\(x\)) e TVP (\emph{recall}) no eixo das abscissas (\(y\)). Conforme \citep{prati2008curvas}, o poto \((0,0)\) representa a estratégia de nunca classificar um exemplo como positivo, modelos que correspondem a esse ponto não representam falso positivo, porém também não conseguem classificar nenhum ponto verdadeiro positivo. Do contrário em \((100\%,100\%)\) representa de sempre classificar um novo exemplo como positivo. Ao ponto \((0,100\%)\) representa o modelo perfeito e todos os exemplos são corretamente classificados e ao ponto \((100\%,0)\) representa ao caso em que o modelo sempre erra em sua predição. Portanto, pode ser representado por duas linhas diagonais: a ascendente representa um modelo de comportamente estocástico em que os pontos pertencentes ao triângulo sueprior esquerdo a essa diagona representam modelos que desempenham melhor que o aleatório e aos pontos que se encontram no triângulo inferior direito representam modelos piores que o aleatório. Para a diagonal descendente temos os modelos de classificação que desempenham igualmente nas duas classes. À esquerda desta linha encontram-se os mdelos que desempenham melhor para a classe negativa em detrimento da positiva e à direita melhor para a classe positiva.

\begin{figure}

{\centering \includegraphics[width=0.7\linewidth]{G:/Hiro/Documents/Meus feitos/Livro ML/bookdown-demo-master/Figuras/roc} 
...
Segue um exemplo de ROC com 5 pontos arbitrários representando 5 modelos de classificação diferentes (A,B,C,D e F) \citep{prati2008curvas}, Neste caso A dizemos ``conservativo'' pois ele faz uma classificação posiiva somente se têm grande segurança na classificação e D é considerado ``liberal'' pois prediz a classe positiva com mais frequência, porém com possibilidade de altas taxas de falsos positivos. Um ponto no espaço ROC é melhor que outro se e somente se estiver acima e à esquerda de outro ponto com uma maior taxa de verdadeiros positivos e uma menor taxa de falsos positivos.

\begin{figure}

{\centering \includegraphics[width=0.7\linewidth]{G:/Hiro/Documents/Meus feitos/Livro ML/bookdown-demo-master/Figuras/roc2} 
...
{\centering \includegraphics[width=0.7\linewidth]{G:/Hiro/Documents/Meus feitos/Livro ML/bookdown-demo-master/Figuras/AUC} 
