...
\begin{equation}
d_(\vec{w},b;\vec{x}_i)=\geq \frac{1}{||\vec{w}\\}
...
\begin{equation}
\displaystyle^n_{i=1}\alpha_i=\frac{1}{2} \displaystyle \sum^n_{i=1}\sum^n_{j=1}\alpha_i\alpha_j y_i y_j \langle\vec{x}_i.x_j\rangle
...
Vamos aproveitar o exemplo que utilizamos de distância Euclidiana, em \ref{meddist}. Com o seguinte banco de dados:

\begin{longtable}[]{@{}ccccccc@{}}
\caption{\label{tab:dadossrenda} Renda e Idade de 6 indíviduos, abordado em \ref{meddist} sobre distância Euclidiana \citep{mingoti2007analise}}\tabularnewline
\toprule
...
\begin{longtable}[]{@{}ccccccc@{}}
\caption{\label{tab:dadosrenda} Renda e Idade de 6 indíviduos, abordado em \ref{meddist} sobre distância Euclidiana \citep{mingoti2007analise}.}\tabularnewline
\toprule
\textbf{Renda} & 9,6 & 8,4 & 2,4 & 18,2 & 3,9 & 6,4\tabularnewline
\midrule
\endfirsthead
